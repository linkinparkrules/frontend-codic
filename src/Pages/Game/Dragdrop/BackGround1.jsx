...
const DragDrop = () => {
    ...
    // [] -> chay khi render xong 
    // none [] -> chay lan dau sau khi render, luon luon chay khi componet re-render
    // [a, b, c, ...] -> chay lan dau sau khi render + khi cac gia tri trong depen thay doi
