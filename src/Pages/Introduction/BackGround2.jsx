    ...
    return (
        <div className="company-history">
            ...
            <div className="company-history-content">
                ...
                <DevProcess className="history-list row36" dataAos="fade-down" dataAosDuration="1600" h2="year" year="2020" src={development} alt="Development Process" h3="period-name" period="Phát triển mạnh mẽ" content="Công ty đạt nhiều giải thưởng, số lượng học viên tăng lên không ngừng" />
                <DevProcess className="history-list row26" dataAos="fade-down" dataAosDuration="1900" h2="year" year="2021" src={stable} alt="Development Process" h3="period-name" period="Giữ vững phong độ" content="Công ty tiếp tục nhận được nhiều danh hiệu, doanh thu tăng lên không ngừng" />
